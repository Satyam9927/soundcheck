...
let () =
  ...
  | Ok report ->
    ...
    let expected_human =
      ...
      \         Assurance: kong-traditional-http-v9 (within_profile)"
    in
    ...
    let expected =
      {|{"result":"vacuous","schema_version":9,"property":"admin-api-not-reachable","assurance":{"profile":"kong-traditional-http-v9","status":"within_profile","findings":[]},"frozen_spec":null,"clause":null,"counterexample":null}|}
    in
